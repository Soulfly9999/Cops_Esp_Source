...
public class FloatingModMenuService extends Service {
	...
	int TEXT_COLOR = Color.parseColor("#D3BA1C");
        int TEXT_COLOR_2 = Color.parseColor("#FFFFFF");
	    int BTN_COLOR = Color.parseColor("#070606");
	    int MENU_BG_COLOR = Color.parseColor("#070606"); //#AARRGGBB
        int MENU_FEATURE_BG_COLOR = Color.parseColor("#070606"); //#AARRGGBB
        int MENU_WIDTH = 275;
        int MENU_HEIGHT = 210;
